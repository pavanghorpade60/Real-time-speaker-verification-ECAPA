...
print("\nBuilding MULTI-REFERENCE Sumanth Speaker Embeddings...")
...
# PATH
# -------------------------------------------------
SPEAKER_NAME = "SUMANTH"
AUDIO_FOLDER = "recordings/sumanth"
OUTPUT_FILE = "sumanth_reference_embeddings.pt"
...
if len(audio_files) == 0:
    print("No audio samples found in recordings/sumanth")
    raise SystemExit
...
# Keep strongest percentage after outlier filtering
KEEP_PERCENT = 0.70
...
def prepare_audio(audio: np.ndarray, sr: int) -> np.ndarray | None:
