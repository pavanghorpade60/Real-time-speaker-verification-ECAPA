...
print("\nBuilding MULTI-REFERENCE Pavan Speaker Embeddings...")
...
# -------------------------------------------------
SPEAKER_NAME = "PAVAN"
AUDIO_FOLDER = "recordings/pavan"
OUTPUT_FILE = "pavan_reference_embeddings.pt"
...
if len(audio_files) == 0:
    print("No audio samples found in recordings/pavan")
    raise SystemExit
