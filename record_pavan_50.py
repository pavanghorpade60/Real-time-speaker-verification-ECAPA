...
# Set to None for default mic, or use an integer device ID
MIC_DEVICE = None
...
OUTPUT_FOLDER = "recordings/pavan"
os.makedirs(OUTPUT_FOLDER, exist_ok=True)

print(f"\nRecording {NUM_SAMPLES} clean samples...\n")
...
def validate_raw_audio(audio: np.ndarray) -> tuple[bool, str, float]:
...
while i <= NUM_SAMPLES:
    ...
    print(f"Saved: pavan_{i:02d}.wav  |  Duration after trim: {trimmed_duration:.2f}s")
    i += 1

print(f"\nAll {NUM_SAMPLES} clean samples recorded successfully!")